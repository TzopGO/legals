...
- Ubicación proporcionada manualmente (pin en mapa)

En el caso de repartidores:
- identificación oficial,
- licencia de conducir,
- fotografía de identificación del repartidor,
...
- asignación y entrega de pedidos,
- comunicación entre usuarios, comercios y repartidores,
